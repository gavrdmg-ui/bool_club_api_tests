...
public class RegistrationSpec {
    ...
    public static ResponseSpecification blankFieldsRegistrationResponseSpec = new ResponseSpecBuilder()
            .log(ALL)
            .expectStatusCode(400)
            .expectBody(matchesJsonSchemaInClasspath(
                    "schemas/registration/registration_with_blank_fields_schema.json"))
            .build();
}